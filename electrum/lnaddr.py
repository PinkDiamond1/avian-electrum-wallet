...
from electrum.util import Satoshis, AvianValue
from .avian import hash160_to_b58_address, b58_address_to_hash160, TOTAL_COIN_SUPPLY_LIMIT_IN_BTC
from .segwit_addr import bech32_encode, bech32_decode, CHARSET
from . import segwit_addr
from . import constants
from .constants import AbstractNet
from . import ecc
from .avian import COIN
...
base58_prefix_map = {
    constants.AvianMainnet.SEGWIT_HRP : (constants.AvianMainnet.ADDRTYPE_P2PKH, constants.AvianMainnet.ADDRTYPE_P2SH),
}
...
class LnAddr(object):
    ...
    def get_amount_sat(self) -> Optional[AvianValue]:
        # note that this has msat resolution potentially
        if self.amount is None:
            return None
        return AvianValue(Satoshis(self.amount * COIN))

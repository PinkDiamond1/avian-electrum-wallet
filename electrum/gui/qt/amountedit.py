...
class AVNAmountEdit(AmountEdit):
...
class FeerateEdit(AVNAmountEdit):
    ...
    def get_amount(self):
        sat_per_byte_amount = AVNAmountEdit.get_amount(self)

...
VERSION_ANNOUNCEMENT_SIGNING_KEYS = (
        "RPuQNvDVBC5Q4fXKyfYLjrunbyqiEYckP5",  # kralverde since avian fork
    )


class UpdateCheck(QDialog, Logger):
    url = "https://raw.githubusercontent.com/Electrum-AVN-SIG/electrum-avian/master/check-version.json"
    download_url = "https://github.com/AvianNetwork/avian-electrum-wallet/releases"
        ...
        def verify(self, message, signature):
            ...
            for address in VERSION_ANNOUNCEMENT_SIGNING_KEYS:
                try:
                    ...
                    verified = ecc.verify_message_with_address(address, sig, message, net=constants.AvianMainnet)
                    break
                except:
                    pass
            if verified:

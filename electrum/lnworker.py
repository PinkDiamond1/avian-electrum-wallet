...
from .avian import opcodes, make_op_return, address_to_scripthash
...
from .avian import redeem_script_to_address
...
class LNWorker(Logger, EventListener, NetworkRetryManager[LNPeerAddr]):
    ...
    async def _get_next_peers_to_try(self) -> Sequence[LNPeerAddr]:
        ...
        if constants.net in (constants.AvianTestnet,):
            fallback_list = FALLBACK_NODE_LIST_TESTNET
        elif constants.net in (constants.AvianMainnet,):

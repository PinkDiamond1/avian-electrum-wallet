...
;Variables
  ...
  !define PRODUCT_WEB_SITE "https://github.com/AvianNetwork/avian-electrum-wallet"
  !define PRODUCT_PUBLISHER "The Avian Community"
...
;Interface Settings
  ...
  !define MUI_ICON "c:\electrum\electrum\gui\icons\electrum-avian.ico"
...
Section
  ...
  File "c:\electrum\electrum\gui\icons\electrum-avian.ico"
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT_NAME}\${PRODUCT_NAME}.lnk" "$INSTDIR\electrum-avian-${PRODUCT_VERSION}.exe" "" "$INSTDIR\electrum-${PRODUCT_VERSION}.exe" 0
  CreateShortCut "$SMPROGRAMS\${PRODUCT_NAME}\${PRODUCT_NAME} Testnet.lnk" "$INSTDIR\electrum-avian-${PRODUCT_VERSION}.exe" "--testnet" "$INSTDIR\electrum-${PRODUCT_VERSION}.exe" 0


  ;Links bitcoin: and lightning: URIs to Electrum
  ;WriteRegStr HKCU "Software\Classes\bitcoin" "" "URL:bitcoin Protocol"
  ;WriteRegStr HKCU "Software\Classes\bitcoin" "URL Protocol" ""
  ;WriteRegStr HKCU "Software\Classes\bitcoin" "DefaultIcon" "$\"$INSTDIR\electrum-avian.ico, 0$\""
  ;WriteRegStr HKCU "Software\Classes\bitcoin\shell\open\command" "" "$\"$INSTDIR\electrum-avian-${PRODUCT_VERSION}.exe$\" $\"%1$\""
  ...
  ;WriteRegStr HKCU "Software\Classes\lightning" "DefaultIcon" "$\"$INSTDIR\electrum-avian.ico, 0$\""
  ...
  WriteRegStr HKCU "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\electrum-avian.ico"
...
Section "Uninstall"
  ...
  DeleteRegKey HKCU "Software\Classes\avian"
